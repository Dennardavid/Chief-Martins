...
export default function Hero() {
  ...
  return (
    <section className="absolute px-4 md:px-8 lg:px-10 top-[50%] md:top-[40%] xl:top-[37%] 2xl:top-[43%] flex flex-col md:block lg:flex-row  gap-2 justify-between text-white">
      <div>
